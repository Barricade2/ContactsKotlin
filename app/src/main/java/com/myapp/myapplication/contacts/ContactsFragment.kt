...
import com.myapp.myapplication.addContact.AddOrEditContactViewModel
...
class ContactsFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        addOrEditContactViewModel = ViewModelProviders.of(mainActivity).get(
            AddOrEditContactViewModel::class.java)
